...
function Seller(){
    ...
    <div className="registercontainer">
      ...
      <input type="email" placeholder="product id" onChange={(e) => setid(e.target.value)} required/>
      <input type="text" placeholder="price" onChange={(e) => setprice(e.target.value)} required/>
      <input type="text" placeholder="availability" onChange={(e) => setavail(e.target.value)} required/>
      <textarea  cols="25" rows="7" placeholder="description" onChange={(e) => setdesc(e.target.value)}>
      </textarea>
